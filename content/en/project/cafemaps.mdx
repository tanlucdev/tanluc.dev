...
<Image
  ...
  width={3344}
  height={1882}
  caption="Cafe Maps combines a warm public discovery experience with search, mobile detail pages, and location-aware cafe recommendations."
  size="lg"
  contained
/>
...
<Image
  ...
  width={3344}
  height={1882}
  caption="The discovery experience helps users browse cafes by search, filters, vibe tags, opening status, ratings, and price range."
  size="lg"
  contained
/>
...
<Image
  ...
  width={3344}
  height={1882}
  caption="Cafe detail pages give users the context they need before visiting: photos, opening hours, address, vibe tags, amenities, price range, save action, and directions."
  size="lg"
  contained
/>
...
<Image
  ...
  width={3344}
  height={1882}
  caption="The internal CMS supports cafe CRUD, blog management, publishing workflow, submissions, dashboard metrics, and bilingual content operations."
  size="lg"
  contained
/>
